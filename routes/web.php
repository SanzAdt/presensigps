...
Route::middleware(['auth:user'])->group(function () {
    ...
    Route::post('/karyawan/{nis}/update', [KaryawanController::class, 'update']);
    Route::post('/karyawan/{nis}/delete', [KaryawanController::class, 'delete']);
    ...
    Route::get('/konfigurasi/{nis}/setjamkerja', [KonfigurasiController::class, 'setjamkerja']);
