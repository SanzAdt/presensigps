...
class PresensiController extends Controller
{
    ...
    public function create()
    {
        ...
        $cek = DB::table('presensi')
            ...
            ->where('nis', $nis)
            ->count();
        $kode_cabang = Auth::guard('karyawan')
            ->user()
            ->kode_cabang;
    ...
    public function cetakrekap(Request $request)
    {
        ...
        $rekap = DB::table('presensi')
            ->selectRaw(
                '`presensi`.`nis`, `karyawan`.`nama_lengkap`, jam_masuk, jam_pulang,' .
            ...
            ->whereRaw('MONTH(tgl_presensi) = ?', [$bulan])
            ->whereRaw('YEAR(tgl_presensi) = ?', [$tahun])
            ->groupByRaw('presensi.nis,nama_lengkap,jam_masuk,jam_pulang')
            ->get();
    ...
    public function izinsakit(Request $request)
    {
        ...
        $query->select('id', 'tgl_izin', 'pengajuan_izin.nis', 'nama_lengkap', 'jabatan', 'status', 'status_approved', 'keterangan');
        $query->join('karyawan', 'pengajuan_izin.nis', '=', 'karyawan.nis');
        ...
        if ($request->filled('status_approved')) {  // Check if the status_approved parameter is set and not empty
