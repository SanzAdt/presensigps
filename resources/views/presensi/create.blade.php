...
@section('header')
    ...
    <div class="appHeader bg-primary text-light">
        ...
        <div class="pageTitle">G-Presensi</div>
        <div class="right"></div>
    </div>
    <!-- * App Header -->
    <style>
...
@section('content')
    ...
    <audio id="notifikasi_in">
        <source src="{{ asset('assets/sounds/notifikasi_in.mp3') }}" type="audio/mpeg">
    </audio>
    <audio id="notifikasi_out">
        <source src="{{ asset('assets/sounds/notifikasi_out.mp3') }}" type="audio/mpeg">
    </audio>
