                        ...
                        <div class="row">
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nis') }}" class="form-control" id="nis"
                            ...
                            <div class="col-3">
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="text" value="{{ Request('nama_lengkap') }}" class="form-control"
                                        id="nama_lengkap" name="nama_lengkap" placeholder="Nama Karyawan">
                                </div>
                            </div>
                            <div class="col-3">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($d->status_approved == 0)
                                            <a href="" class="btn btn-sm btn-primary text-white" id="approve"
                                                id_izinsakit="{{ $d->id }}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
