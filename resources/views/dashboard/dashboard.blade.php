            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 15px; font-size: 0.6rem; z-index: 999;">{{ $rekappresensi->jmlhadir }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 15px; font-size: 0.6rem; z-index: 999;">{{ $rekapizin->jmlizin }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 15px; font-size: 0.6rem; z-index: 999;">{{ $rekapizin->jmlsakit }}</span>
                ...
                <div class="col-3">
                    <div class="card">
                        <div class="card-body text-center" style="padding: 12px 12px !important; line-height: 0.8rem">
                            <span class="badge bg-danger"
                                style="position: absolute; top: 3px; right: 15px; font-size: 0.6rem; z-index: 999;">{{ $rekappresensi->jmlterlambat }}</span>
                            ...
                            <div class="card-body">
                                <div class="historicontent">
                                    ...
                                    <div class="datapresensi">
                                        ...
                                        <span>
                                            {!! $d->jam_in ? date('H:i', strtotime($d->jam_in)) : '<span class="text-danger">Belum Absen</span>' !!}
                                        </span>
                                        <span>
                                            {!! $d->jam_out ? '- ' . date('H:i', strtotime($d->jam_out)) : '<span class="text-danger">- Belum Absen</span>' !!}
                                        </span>
                                        <div id="keterangan" style="margin-top: 3px !important">
                                            @php
